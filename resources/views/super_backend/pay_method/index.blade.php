...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">{{__('Payment Methods')}} <small>{{__('Payment Method')}}</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">{{__('Payment Methods')}}</span>
                        </div>
                        <div class="actions">
                            <a href="{{ route('create.payment.method') }}" class="btn btn-xs btn-success">
                                <i class="glyphicon glyphicon-plus"></i> {{__('Add New Payment Method')}}
                            </a>
                        </div>
                    </div>
                                        ...
                                        <tr role="row" class="filter"> 
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="industry"
                                                       id="industry" autocomplete="off" placeholder="Payment Method">
                                            </td>
                                            <td>
