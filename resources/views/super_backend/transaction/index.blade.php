        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <span>{{__('TRANSACTIONS REPORT')}}</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">{{__('Transactions Report  ')}}<small>{{__('  Reporting')}}</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"> <i class="icon-settings font-dark"></i>
                                <span class="caption-subject font-dark sbold uppercase">{{__('Reporting Tx')}}</span>
                            </div>
                            <div class="actions">
                                @include('super_backend.transaction.inc.modal')
                                <a href="" class="btn btn-success btn-rounded mb-4"
                                   data-toggle="modal" data-target="#modalLoginForm"><i class="fa fa-download"></i>
                                    {{__('   Modal Report Form')}}
                                </a>
                            </div>
                        </div>
                                ...
                                <form method="post" role="form" id="transaction-search-form">
                                    <table class="table table-striped table-bordered table-hover"
                                        ...
                                        <tr role="row" class="filter">
                                            ...
                                            <td>
                                                <input type="text" class="form-control"
                                                       name="branch_name" id="branch_name" autocomplete="off">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"
                                                   name="package" id="package" autocomplete="off">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="gateway"
                                                   id="gateway" autocomplete="off">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"
                                                   name="total" id="total" autocomplete="off"></td>
                                            <td>
                                                <input type="text" class="form-control"
                                                   name="created_at" id="created_at" autocomplete="off">
                                            </td>
    ...
    <script>
        ...
        function delete_newsContent(id) {
            if (confirm('Are you sure! you want to delete?')) {
                $.post("#", {id: id, _method: 'DELETE', _token: '{{ csrf_token() }}'})
