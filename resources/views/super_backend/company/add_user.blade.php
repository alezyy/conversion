    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.companies') }}">{{__('Companies Users')}}</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li> <span>{{__('Add Company User')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->        
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i>
                            <span class="caption-subject bold uppercase">{{__('Company User Form')}}</span>
                        </div>
                    </div>
                    <div class="portlet-body form">          
                        ...
                        {!! Form::open(
                        array('method' => 'post', 'route' => 'store.user.company',
                        'class' => 'form', 'files'=>true)) !!}
                        <div class="tab-content">              
                            <div class="tab-pane fade active in" id="Details">
                                @include('super_backend.company.forms.form_user')
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
