        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <span>{{__('Companies Contracts')}}</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">
                {{__('Manage Companies Contracts')}}
            </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="{{ route('create.contract.company') }}" class="btn btn-xs btn-success">
                                    <i class="glyphicon glyphicon-plus"></i> {{__('Add New Company Contract')}}
                                </a>
                            </div>
                        </div>
