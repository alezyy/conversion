        ...
        <div class="col-md-6">
            <div class="form-group {!! APFrmErrHelp::hasError($errors, 'logo') !!}">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div> <span class="btn default btn-file"> <span class="fileinput-new"> {{__('Select Company logo')}} </span>
                            <span class="fileinput-exists"> {{__('Change')}} </span> {!! Form::file('logo', null, array('id'=>'logo')) !!} </span>
                        <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput"> {{__('Remove')}} </a> </div>
                </div>
