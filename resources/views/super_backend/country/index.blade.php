    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>{{__('Countries')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">{{__('Manage Countries')}} <small>{{__('Countries')}}</small> </h3>
        <!-- END PAGE TITLE-->
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">{{__('Countries')}}</span> </div>
                        <div class="actions">
                            <a href="{{ route('create.country') }}" class="btn btn-xs btn-success">
                                <i class="glyphicon glyphicon-plus"></i>{{__('Add New Country')}}</a> </div>
                    </div>
                    <div class="portlet-body">
                        <div class="table-container">
                            <form method="post" role="form" id="country-search-form">
                                <table class="table table-striped table-bordered table-hover"
                                       id="countryDatatableAjax">
                                    <thead>
                                    <tr role="row" class="filter">
                                        <td>{!! Form::select('lang', ['' => __('Select Language')]+$languages,
                                        config('default_lang'), array('id'=>'lang', 'class'=>'form-control')) !!}
                                        </td>
                                        <td>
                                            <input type="text" class="form-control"
                                               name="country" id="country"
                                               autocomplete="off" placeholder={{__('Country')}}>
                                        </td>
                                        <td>
