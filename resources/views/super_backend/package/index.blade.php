                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">{{__('Packages')}}</span>
                        </div>
                        <div class="actions"> <a href="{{ route('create.package') }}" class="btn btn-xs btn-success">
                                <i class="glyphicon glyphicon-plus"></i>{{__('Add New Package')}}</a>
                        </div>
                    </div>
                                        ...
                                        <tr role="row" class="filter">
                                            <td>
                                                <input type="text" class="form-control"
                                                   name="package_title"
                                                   id="package_title" autocomplete="off" placeholder="Package Title">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control"
                                                   name="package_price" id="package_price"
                                                   autocomplete="off" placeholder="package price">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" name="package_num_days"
                                                   id="package_num_days" autocomplete="off"
                                                   placeholder="Lang">
                                            </td>
