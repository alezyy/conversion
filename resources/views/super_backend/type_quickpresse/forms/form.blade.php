...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'type_quickpresse') !!}">
        {!! Form::label('type_quickpresse', 'Type Quickpresse', ['class' => 'bold']) !!}
        {!! Form::text('type_quickpresse', null,
        array('class'=>'form-control', 'id'=>'type_quickpresse', 'placeholder'=>'Type Quickpresse', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'type_quickpresse') !!}
    </div>
