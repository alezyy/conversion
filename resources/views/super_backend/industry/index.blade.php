    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <span>{{__('Industries')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">{{__('Manage Industries')}} <small>{{__('Industries')}}</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">{{__('Industries')}}</span>
                        </div>
                        <div class="actions">
                            <a href="{{ route('create.industry') }}" class="btn btn-xs btn-success">
                                <i class="glyphicon glyphicon-plus"></i> {{__('Add New Industry')}}
                            </a>
                        </div>
                    </div>
                                        ...
                                        <tr role="row" class="filter"> 
                                            ...
                                            <td>
                                                <input type="text" class="form-control" name="industry"
                                                       id="industry" autocomplete="off" placeholder="Industry">
                                            </td>
                                            <td>
