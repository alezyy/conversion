...
<div class="page-content-wrapper"> 
    ...
    <div class="page-content"> 
        ...
        <!-- END PAGE BAR --> 
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title">{{__('Manage Products')}} <small>{{__('Products')}}</small> </h3>
        <!-- END PAGE TITLE--> 
        <!-- END PAGE HEADER-->
        <div class="row">
            <div class="col-md-12"> 
                ...
                <div class="portlet light portlet-fit portlet-datatable bordered">
                    <div class="portlet-title">
                        <div class="caption"> <i class="icon-settings font-dark"></i>
                            <span class="caption-subject font-dark sbold uppercase">{{__('Products')}}</span>
                        </div>
                        <div class="actions"> <a href="{{ route('create.product') }}" class="btn btn-xs btn-success">
                                <i class="glyphicon glyphicon-plus"></i>{{__('Add New Product')}}</a>
                        </div>
                    </div>
                                        ...
                                        <tr role="row" class="filter">
                                            <td>
                                                <input type="text" class="form-control"
                                                   name="package_title"
                                                   id="package_title" autocomplete="off" placeholder="Product Title">
                                            </td>
                                            <td>
