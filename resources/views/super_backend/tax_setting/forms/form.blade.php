...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'tax_name') !!}">
        {!! Form::label('tax_name', 'Tax name', ['class' => 'bold']) !!}
        {!! Form::text('tax_name', null, array('class'=>'form-control', 'id'=>'country', 'placeholder'=>'Tax name')) !!}
        {!! APFrmErrHelp::showErrors($errors, 'country') !!}                                       
    </div>
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'nationality') !!}">
        {!! Form::label('nationality', 'Tax value', ['class' => 'bold']) !!}
        {!! Form::text('nationality', null, array('class'=>'form-control', 'id'=>'nationality', 'placeholder'=>'Tax value')) !!}
