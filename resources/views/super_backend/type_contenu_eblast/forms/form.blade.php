...
<div class="form-body">
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'type_contenu_eblast') !!}">
        {!! Form::label('type_contenu_eblast', 'Type Contenu Eblast', ['class' => 'bold']) !!}
        {!! Form::text('type_contenu_eblast', null,
        array('class'=>'form-control', 'id'=>'type_contenu_eblast', 'placeholder'=>'Type Contenu Eblast', 'dir'=>$direction)) !!}
        {!! APFrmErrHelp::showErrors($errors, 'type_contenu_eblast') !!}
    </div>
