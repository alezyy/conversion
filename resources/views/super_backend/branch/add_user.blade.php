    ...
    <div class="page-content"> 
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li> <a href="{{ route('list.users.branches') }}">{{__('Branches Users')}}</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li> <span>{{__('Add Branch User')}}</span> </li>
            </ul>
        </div>
        <!-- END PAGE BAR -->        
        <!-- END PAGE HEADER-->
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i>
                            <span class="caption-subject bold uppercase">{{__('Branch User Form')}}</span>
                        </div>
                    </div>
                    <div class="portlet-body form">          
                        ...
                        {!! Form::open(
                        array('method' => 'post', 'route' => 'store.user.branch',
                        'class' => 'form', 'files'=>true)) !!}
                        <div class="tab-content">              
                            <div class="tab-pane fade active in" id="Details">
                                @include('super_backend.branch.forms.form_user')
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
