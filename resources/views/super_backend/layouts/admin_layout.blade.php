...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="#">
                <img src="{{ asset('/') }}image/quickpresse-white.svg" alt="logo"
                     style="width:160px; height:50px;" /> <!-- class="logo-default" --></a>
    ...
    @include('super_backend.shared.top_menu')
...
<div class="page-container">
    <!-- BEGIN SIDEBAR -->
    <div class="page-sidebar-wrapper"> @include('super_backend.shared.sidebar') </div>
    <!-- END SIDEBAR -->
    <!-- BEGIN CONTENT -->
@yield('content')
<!-- END CONTENT -->
...
<div class="page-footer">
    <div class="page-footer-inner"> {{ date('Y')}} © {{ 'Quickpresse' }}. {{__('Admin Panel')}}. </div>
